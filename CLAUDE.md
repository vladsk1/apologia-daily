...
> ✅ **OWNER DECISION 2026-09-23 — OLD-EARTH HALF SETTLED: keep old-earth cosmology as is.** Figures such as
> "13.8 billion years" may stand in our own voice, as the certified essays and the explainer videos state them.
> Gates should stop raising it as an open question. ⚠ This settles **only** the old-earth half; the
> intelligent-design-inference half of the question above was not addressed and remains open.
