// content-review: {"argument": "2026-08-10", "orthodoxy": "2026-08-10", "by": "FIRST GATE of this new file. apologia-orthodoxy round 3: CLEAN + STAMPABLE — CRISIS_REPLY re-read clause-by-clause and confirmed a faithful port of the certified PASTORAL CARE block in api/ask.js (imago Dei and God's love stated as universal claims about God's disposition, NOT the reader's standing, so not universalism; Christ offered as presence not argument; referral before disclaimer; denominationally neutral 'pastor or priest'; no diagnosis; no verdict on the eternal fate of the suicided, which divides the traditions and is not this file's job). apologia-argument round 3: SOUND — concedes nothing, asserts nothing about the reader's standing, no overstatement, the third-party sentence does the work the header claims. Three rounds of both lenses. WHAT THE STAMP DOES NOT COVER: human/pastoral sign-off, still _pending_ in docs/STATEMENT_OF_FAITH.md — and this is the sentence the site says to someone in danger. KNOWN AND RECORDED, not assumed: the regex catches ~20 fixed phrasings and misses most of how distress is actually expressed; 'Do people who commit suicide go to hell?' is an accepted false positive the third-party sentence mitigates, and 'I don't want to die - is there an afterlife?' is an accepted UNMITIGATED misfire."}
...
// sentence below. ⚠ That de-fangs the FIRST case only: a bereaved asker is
// addressed by it. The second is first-person, non-crisis and about nobody else,
// so that reader still gets told their life has real worth and that reaching out
// was brave. It is an accepted, UNMITIGATED misfire, not a solved one.
