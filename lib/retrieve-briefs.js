...
const STOP = new Set([
  ...
  // NB: unlike lib/retrieve-sources.js, "god"/"jesus"/"christ"/"lord" and
  // "christian(s)" are NOT stopped here — in this small topical corpus they carry
  // real signal (they are the very subject of the deity/Trinity/"are X Christians?"
  // briefs, e.g. "is Jesus God?", "are Mormons Christians?"). The high score
  // threshold + curated tags keep precision; see the tuning battery in the test.
]);
