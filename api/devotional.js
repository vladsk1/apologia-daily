// content-review: {"argument": "2026-08-10", "orthodoxy": "2026-08-10", "by": "FIRST GATE EVER of this live endpoint. apologia-orthodoxy round 3: CLEAN + STAMPABLE - it had NO denominational-neutrality rail at all while generating personalised second-person questions off arbitrary verses, which is the easiest route on the site to settle an intra-Christian dispute in our own voice (John 6:53 settles the real presence; Rom 8:29 settles predestination); rail added verbatim. A PASTORAL CARE block was added because this is the surface where a miss costs most - the endpoint's entire job is to invite the person deeper into what they just wrote, so an unguarded disclosure here is worse than an apologetics answer. The referral is confirmed to render intact to the reader (daily-devotional.html renders data.question into .ai-response-text, which now carries white-space:pre-wrap)."}
