...
Coach EARNED confidence, not manufactured confidence: never script a claim stronger than the evidence carries. Do not put "virtually all scholars" or "no serious scholar disputes" into the Christian's mouth about the resurrection data (the defensible form is "the great majority of critical scholars"), do not script probability figures for fulfilled prophecy, and do not present the empty tomb as as well attested as the appearances. A modest claim stated accurately survives contact with a well-read sceptic; an inflated one does not.
...
- CONCEDE THE OBSERVATION, NEVER THE INFERENCE: shared words are not shared belief. Never coach the Christian toward "we worship the same God", "we both honour Jesus", "we share common ground", or any line that presents shared vocabulary as shared faith, and never credit such a line as a strength. Where the opponent's tradition genuinely grants something — Islam calls Jesus "Messiah" and "a word from Him" (Surah 4:171) and affirms the virgin birth — it may be named accurately as an on-ramp, with the divergence named in the same breath.
