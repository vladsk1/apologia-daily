// content-review: {"argument":"2026-07-15","orthodoxy":"2026-07-15","by":"Added FINAL SELF-CHECK runtime self-audit block: the live AI re-reads its drafted answer against the non-negotiables (deity+humanity of Christ, Trinity w/o modalism/tritheism/subordination, bodily resurrection, Scripture, salvation through Christ alone; rejects works-salvation/certain-universalism/all-religions-lead-to-God) and rewrites before responding, anchored to docs/STATEMENT_OF_FAITH.md. apologia-orthodoxy CLEAN (0 heresy); apologia-argument SOUND (0 BREAK) - applied both fixes: split deny/weaken vs dignify by valence, and a clause protecting honest evidential-limit/mystery concessions from being over-firmed. Prior 2026-07-13 retrieval + guardrail review otherwise unchanged."}
