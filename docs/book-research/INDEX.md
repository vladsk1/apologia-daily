...
| ⭐ **Resurrection — the minimal-facts case & the published scholar-survey** | **`habermas-on-the-resurrection.md`** (⚠ Habermas, ***On the Resurrection***, 4 vols, B&H Academic — **NOT OWNED / NOT READ**; PARTIAL, search-derived. ⚠ note the common title mix-up: *A New Historiographical Approach* is Licona's 2010 book, not this one — see the note's correction banner) | `library/minimalfacts.html` is already best-in-market (cites Habermas 2005 *JSHJ* + 2012 STR; engages Allison/Cavin/Carrier/GCRR; Licona bedrock/second-order shipped 2026-09-18). **The one real lead: Vol. 3, *Scholarly Perspectives* (2025), PUBLISHES the survey the GCRR critique called unpublished** → bounded P3 currency update to `minimalfacts.html` fn 29/30 (publication ≠ auditable open dataset — keep bounded). Vol. 2 *Refutations* / Vol. 4 *Theology and Practice* deferred until owned. ⚠ keep "several thousand sources" (not a hard number); never add a hard % |
