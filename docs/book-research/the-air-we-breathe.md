...
| C. S. Lewis "crooked line implies a straight line" + Denhollander | *Mere Christianity* Bk 2 ch. 1; CNN transcript | For `library/moral.html`. **✅ SHIPPED 2026-08-24** (backlog row 224) into the Premise-2 section. ⭐ `apologia-citations` confirmed Denhollander **invoked Lewis's "straight line" herself** at the sentencing (both quotes verbatim). Lewis paraphrased (copyright); cited inline. Gated argument [STRONG] + orthodoxy [CLEAN]. |
