...
| **Colin J. Hemer** ×3 (*TynBul* 36 [1985] 79–109; 40.1 [1989] 77–85; 40.2 [1989] 239–59) **+ David Seccombe** (*TynBul* 71.2 [2020] 207–27) **+ F. F. Bruce**, *The Speeches in the Acts of the Apostles* (Tyndale Press, 1942) | publisher OA ×4; Bruce via permission-based mirror (© Bruce, "reproduced by permission") | tyndalebulletin.org ×4; biblicalstudies.org.uk /pdf/tp/speeches_bruce.pdf | `acts-historicity-bruce-hemer-seccombe.md` | — | — (note **MINED** 2026-07-26, 5 texts — ⚠️ **read-coverage varies: Hemer *TynBul* 36 / Hemer 40.1 / Seccombe are COMPLETE; Hemer 40.2 (pp. 1–9 of 21) and Bruce (pp. 1–8, 18–21 of 21) are PARTIAL** — see the note's header table. **IMPROVEMENT ×3** → backlog: the Acts 27–28 voyage epigraphy for `archaeology.html`; Seccombe's three non-silence arguments for `earlydate.html`; NEW coverage of "are the speeches in Acts invented?") | 2026-07-26 |
| **Alan R. Millard** ×2 · "Daniel in Babylon: An Accurate Record?" (in Hoffmeier & Magary, eds., *Do Historical Matters Matter to Faith?*, Crossway 2012, 263–80) · "The Knowledge of Writing in Iron Age Palestine" (*TynBul* 46.2 [1995] 207–17) | permission-based mirror (Crossway-permitted) / publisher OA | biblicalstudies.org.uk /pdf/crossway/daniel_millard.pdf; tyndalebulletin.org /article/30407-…pdf | `millard-daniel-and-scribal-culture.md` | — | — (note **MINED** 2026-07-26 — Daniel chapter COMPLETE (18/18 pp.); the *TynBul* literacy article near-complete (pp. 5–6 of 11 unread). Belshazzar = **corroboration** [already live]. **IMPROVEMENT ×2** → backlog: a bounded Darius-the-Mede + Sargon II line for `archaeology.html`; NEW coverage of Iron-Age writing/literacy) | 2026-07-26 |
| **Peter M. Head & P. J. Williams** · "Q Review" · *Tyndale Bulletin* 54.1 (2003) 119–44 | publisher OA | tyndalebulletin.org /article/30227-q-review.pdf | `head-williams-q-review.md` | — | — (note ⚠️ **PARTIAL** 2026-07-26, pp. 1–8 + 22–26 of 26 read; pp. 9–21 unread — the brief's "Williams article" search resolved here; his onomastics/geography case is in the **book** → `book-research/can-we-trust-the-gospels.md`. **IMPROVEMENT ×1** → backlog: a specialist caveat on the Casey footnote in `jewishness.html`) | 2026-07-26 |
...
| **K. A. Kitchen** · "Historical Method and Early Hebrew Tradition" · *Tyndale Bulletin* 17 (1966) 63–97 | publisher OA | tyndalebulletin.org /article/30688-…pdf | `kitchen-historical-method-hebrew-tradition.md` | — | — (note ⚠️ **PARTIAL** 2026-07-26, pp. 1–14 + 30–33 of 35 read; the unread pp. 15–29 are the patriarchal-*dating* material we deliberately quarantine. ⚠ **1966 — pre-dates the Thompson/Van Seters critique.** Treaty-form argument = **corroboration** (already live + already labelled contested). **IMPROVEMENT ×1** → backlog: the **Merneptah Stele** for `archaeology.html`. Plus a deliberate **NON-recommendation** on the Nuzi material, recorded on purpose) | 2026-07-26 |
| **Gary Habermas** · free author-hosted article CORPUS (enumeration, not a single article) · `garyhabermas.com/articles/` | author-hosted [legal] — ⚠ **index EGRESS-BLOCKED this session; search-derived, PARTIAL** | garyhabermas.com/articles/articles.htm | `habermas-free-articles-corpus.md` | — | — (enumeration only; 7 articles already mapped in 6 prior notes. **Top NET-NEW lead: "Recent Perspectives on the Reliability of the Gospels," CRJ 28.1 [2005]** → logged P3 in content-backlog, OPEN/blocked on a web-enabled fetch. NDE/Shroud/Doubt = non-recommendations) | 2026-09-18 |
| **Jonathan McLatchie** · broader corpus (author-hosted essays + a *BIO-Complexity* 2024 ID paper) | author-hosted / ID journal | jonathanmclatchie.com (⚠ **egress-BLOCKED** this session) | `mclatchie-corpus.md` | — | — (note **SURVEY-level** 2026-09-18 — primary pages egress-blocked; assembled from WebSearch + our own `coincidences.html`; credentials corroborated from ≥5 secondary listings, UNVERIFIED from source. Undesigned coincidences = **corroboration** (ours already cites his Carrier series). **IMPROVEMENT ×2** → backlog: name the maximal-data critique on `minimalfacts.html` (P3, non-adjudicating); Paul/Jerusalem plank on `islam-jesusmuslim.html` (P3). ⚠ **ID/biology = SENSITIVE, do-not-import**; reportage-vs-Licona = **NON-recommendation** (intramural). Do NOT re-map his trilemma — `mclatchie-trilemma-jesuschar.md`) | 2026-09-18 |
