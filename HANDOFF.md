...
12. **"The Case, Plainly" tier (76 arguments, 7 tabs)** — a warm plain-English positive-case walkthrough (~850–950 words) inlined as the FIRST paid block in every argument card, under the Upgrade gate and before the deep dive. Tabs: Jesus (`ev-s3`, 15), Resurrection (`ev-s2`, 8), Biblical Reliability (`ev-s4`, 11), Trinity (`ev-s6`, 10), God's Existence (`ev-s1`, 12), Science & Faith (`ev-s5`, 7), Islam in Worldviews (`worldviews.html` Islam section, 13). All 76 orthodoxy-gated CLEAN.
